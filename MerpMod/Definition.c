...
//DEFINERAMVAR("MerpMod Map Blending Input Mode",BlendRatioInput,"uint8","E");
...
DEFINERAMVAR("MerpMod Base Timing Final Target",BaseTiming,"float","E");
DEFINERAMVAR("MerpMod Timing Final Output",TimingHackOutput,"float","E"); //TODO: Change name in actual definition
