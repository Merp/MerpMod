...
#define MOD_DATE 14.10.17.16.54
#include "Flash.h"
...
#define pFlagsRevLim ((unsigned char*)0xFFFF7CD0)
...
#define pCelSignalOem ((unsigned char*)0xFFFFAEEE)
...
#define pClutchFlags ((unsigned char*)0xFFFF65F4)
