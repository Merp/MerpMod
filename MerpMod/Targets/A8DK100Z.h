#define MOD_ECUID 85E934FF7E
#define MOD_DATE 14.10.17.19.01
#include "Flash.h"
#define MOD_CONFIG Flash
#define MOD_BUILD Debug
#define MOD_RELEASE 0
#define ECU_CALIBRATION_ID A8DK100Z
#define ECU_IDENTIFIER 4D42594006
/////////////////////
// NonSpecific Rom Info and Routines
/////////////////////

#define dCalId (0x00002000)
#define dEcuId (0x000CD46C)
#define dRomHoleStart (0x000E1000)
#define pRamHoleStart (0xFFFF8FF0)
...
#define dInjectorScaling ((float*)0x000C5FB0)
...
#define dLoadSmoothingA (0x000C0FF8)
#define dLoadSmoothingB (0x000C0FFC)
#define dLoadSmoothingFinal (0x000C1008)
