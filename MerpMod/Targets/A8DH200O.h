#define MOD_DATE 14.7.6.1539

#include "Flash.h"
#define MOD_CONFIG Flash
#define MOD_BUILD Testing
#define MOD_RELEASE 0
#define ECU_CALIBRATION_ID A8DH200O
#define ECU_IDENTIFIER 4352584006
/////////////////////
// NonSpecific Rom Info and Routines
/////////////////////

#define dCalId (0x00002000)
#define dEcuId (0x000CDA84)
#define dRomHoleStart (0x000E1000)
#define pRamHoleStart (0xFFFF8F60)
...
#define dInjectorScaling ((float*)0x000C693C)
...
#define dLoadSmoothingA (0x000C1A18)
#define dLoadSmoothingB (0x000C1A1C)
#define dLoadSmoothingFinal (0x000C1A28)
